let index_hero = { title: "Our Lady of Fatima Church", sub_title: "A Community of Faith and Love" };
...
let index_welcome = { title: "Welcome to Our Parish", content: ["Our Lady of Fatima Church is situated off the Ghodbunder Road at the Majiwada Junction. Around a thousand families reside in this parish which is divided into 24 Small Christian Communities.", "Voluntary Church organizations, cells and groups such as Sodality, SVP, Senior Citizens Group, HR Cell, Family Cell, Communications Cell, Prison Ministry, Choir, Extraordinary Ministers of Holy Communion, Social Justice Cell, Legion of Mary, Pre-baptismal Catechesis Team, Lector's Ministry, Sunday School Teachers and Bombay Catholic Sabha work in assigned areas to support the Priest in Charge in Church functions.", "A Parish Pastoral Council and an Executive Committee perform the consultative function in administrative duties of the Parish. Other committees such as the Finance Committee, Cemetery Committee are appointed to assist the Priest in Charge.", "This site is launched with the purpose of providing a platform for communication between the church and the faithful. The communications cell is committed to keep this site updated with the current information for the benefit of the faithful and others who wish to know about our parish and its activities."] };
...
let index_events = { title: "Upcoming events", content: [{ url: "images/event.jpeg", name: "Easter Mass", date: "April 20, 2025 | 6:00 PM", description: "Join us for the celebration of the mass" }] };
